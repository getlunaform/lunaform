...
// ListDeploymentsParams contains all the bound params for the list deployments operation
...
func (o *ListDeploymentsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
