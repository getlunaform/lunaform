...
// UndeployStackParams contains all the bound params for the undeploy stack operation
...
func (o *UndeployStackParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
