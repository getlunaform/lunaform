...
// GetStackParams contains all the bound params for the get stack operation
...
func (o *GetStackParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
