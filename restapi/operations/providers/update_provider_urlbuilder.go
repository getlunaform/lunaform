...
func (o *UpdateProviderURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("Name is required on UpdateProviderURL")
	}
...
func (o *UpdateProviderURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateProviderURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateProviderURL")
	}
