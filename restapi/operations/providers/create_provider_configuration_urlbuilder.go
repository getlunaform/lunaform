...
func (o *CreateProviderConfigurationURL) WithBasePath(bp string) *CreateProviderConfigurationURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateProviderConfigurationURL) String() string {
...
func (o *CreateProviderConfigurationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateProviderConfigurationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateProviderConfigurationURL")
	}
