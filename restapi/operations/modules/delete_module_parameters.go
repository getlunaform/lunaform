...
// DeleteModuleParams contains all the bound params for the delete module operation
...
func (o *DeleteModuleParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
