...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourcesApi();
  });
  ...
  describe('ResourcesApi', function() {
    describe('listResourceGroups', function() {
      it('should call listResourceGroups successfully', function(done) {
        //uncomment below and update the code to test listResourceGroups
        //instance.listResourceGroups(function(error) {
