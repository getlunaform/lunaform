...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListTfWorkspaces();
  });
  ...
  describe('ResponseListTfWorkspaces', function() {
    it('should create an instance of ResponseListTfWorkspaces', function() {
      // uncomment below and update the code to test ResponseListTfWorkspaces
      //var instane = new Lunaform.ResponseListTfWorkspaces();
      //expect(instance).to.be.a(Lunaform.ResponseListTfWorkspaces);
    });
