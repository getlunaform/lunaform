...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.HalCurie();
  });
  ...
  describe('HalCurie', function() {
    it('should create an instance of HalCurie', function() {
      // uncomment below and update the code to test HalCurie
      //var instane = new Lunaform.HalCurie();
      //expect(instance).to.be.a(Lunaform.HalCurie);
    });
