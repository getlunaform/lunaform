...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListTfDeployments();
  });
  ...
  describe('ResponseListTfDeployments', function() {
    it('should create an instance of ResponseListTfDeployments', function() {
      // uncomment below and update the code to test ResponseListTfDeployments
      //var instane = new Lunaform.ResponseListTfDeployments();
      //expect(instance).to.be.a(Lunaform.ResponseListTfDeployments);
    });
