...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListResources();
  });
  ...
  describe('ResponseListResources', function() {
    it('should create an instance of ResponseListResources', function() {
      // uncomment below and update the code to test ResponseListResources
      //var instane = new Lunaform.ResponseListResources();
      //expect(instance).to.be.a(Lunaform.ResponseListResources);
    });
