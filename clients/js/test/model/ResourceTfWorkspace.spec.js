...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceTfWorkspace();
  });
  ...
  describe('ResourceTfWorkspace', function() {
    it('should create an instance of ResourceTfWorkspace', function() {
      // uncomment below and update the code to test ResourceTfWorkspace
      //var instane = new Lunaform.ResourceTfWorkspace();
      //expect(instance).to.be.a(Lunaform.ResourceTfWorkspace);
    });
