...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListTfStateBackends();
  });
  ...
  describe('ResponseListTfStateBackends', function() {
    it('should create an instance of ResponseListTfStateBackends', function() {
      // uncomment below and update the code to test ResponseListTfStateBackends
      //var instane = new Lunaform.ResponseListTfStateBackends();
      //expect(instance).to.be.a(Lunaform.ResponseListTfStateBackends);
    });
