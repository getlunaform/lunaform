...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceListTfStack();
  });
  ...
  describe('ResourceListTfStack', function() {
    it('should create an instance of ResourceListTfStack', function() {
      // uncomment below and update the code to test ResourceListTfStack
      //var instane = new Lunaform.ResourceListTfStack();
      //expect(instance).to.be.a(Lunaform.ResourceListTfStack);
    });
