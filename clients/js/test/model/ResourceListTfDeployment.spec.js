...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceListTfDeployment();
  });
  ...
  describe('ResourceListTfDeployment', function() {
    it('should create an instance of ResourceListTfDeployment', function() {
      // uncomment below and update the code to test ResourceListTfDeployment
      //var instane = new Lunaform.ResourceListTfDeployment();
      //expect(instance).to.be.a(Lunaform.ResourceListTfDeployment);
    });
