...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceListTfWorkspace();
  });
  ...
  describe('ResourceListTfWorkspace', function() {
    it('should create an instance of ResourceListTfWorkspace', function() {
      // uncomment below and update the code to test ResourceListTfWorkspace
      //var instane = new Lunaform.ResourceListTfWorkspace();
      //expect(instance).to.be.a(Lunaform.ResourceListTfWorkspace);
    });
