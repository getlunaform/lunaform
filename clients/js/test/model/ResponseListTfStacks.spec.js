...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListTfStacks();
  });
  ...
  describe('ResponseListTfStacks', function() {
    it('should create an instance of ResponseListTfStacks', function() {
      // uncomment below and update the code to test ResponseListTfStacks
      //var instane = new Lunaform.ResponseListTfStacks();
      //expect(instance).to.be.a(Lunaform.ResponseListTfStacks);
    });
