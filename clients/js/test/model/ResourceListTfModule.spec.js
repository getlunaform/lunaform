...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceListTfModule();
  });
  ...
  describe('ResourceListTfModule', function() {
    it('should create an instance of ResourceListTfModule', function() {
      // uncomment below and update the code to test ResourceListTfModule
      //var instane = new Lunaform.ResourceListTfModule();
      //expect(instance).to.be.a(Lunaform.ResourceListTfModule);
    });
