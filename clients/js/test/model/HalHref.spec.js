...
(function(root, factory) {
  ...
  describe('HalHref', function() {
    it('should create an instance of HalHref', function() {
      // uncomment below and update the code to test HalHref
      //var instane = new Lunaform.HalHref();
      //expect(instance).to.be.a(Lunaform.HalHref);
    });
