...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.HalRscLinks();
  });
  ...
  describe('HalRscLinks', function() {
    it('should create an instance of HalRscLinks', function() {
      // uncomment below and update the code to test HalRscLinks
      //var instane = new Lunaform.HalRscLinks();
      //expect(instance).to.be.a(Lunaform.HalRscLinks);
    });

    it('should have the property curies (base name: "curies")', function() {
      // uncomment below and update the code to test the property curies
      //var instane = new Lunaform.HalRscLinks();
