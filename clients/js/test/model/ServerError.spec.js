...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ServerError();
  });
  ...
  describe('ServerError', function() {
    it('should create an instance of ServerError', function() {
      ...
      //var instane = new Lunaform.ServerError();
      //expect(instance).to.be.a(Lunaform.ServerError);
    });

    it('should have the property statusCode (base name: "status-code")', function() {
