...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceTfModule();
  });
  ...
  describe('ResourceTfModule', function() {
    it('should create an instance of ResourceTfModule', function() {
      // uncomment below and update the code to test ResourceTfModule
      //var instane = new Lunaform.ResourceTfModule();
      //expect(instance).to.be.a(Lunaform.ResourceTfModule);
    });
