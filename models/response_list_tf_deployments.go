...
// swagger:model response-list-tf-deployments
...
func (m *ResponseListTfDeployments) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseListTfDeployments) validateEmbedded(formats strfmt.Registry) error {
...
func (m *ResponseListTfDeployments) validateLinks(formats strfmt.Registry) error {
...
func (m *ResponseListTfDeployments) UnmarshalBinary(b []byte) error {
	var res ResponseListTfDeployments
