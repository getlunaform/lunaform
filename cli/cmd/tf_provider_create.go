...
// tfProviderCreateCmd represents the tfProviderCreate command
var tfProviderCreateCmd = &cobra.Command{
	Use:   "add",
	Short: "Add provider",
...
func init() {
	flags := tfProviderCreateCmd.Flags()
	flags.StringVar(&tfProviderCreateNameFlag,
		"name", "", "Terraform provider name")
	tfProviderCreateCmd.MarkFlagRequired("name")
}
