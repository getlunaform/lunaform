...
func (o *GetProviderConfigurationNotFound) Error() string {
	return fmt.Sprintf("[GET /tf/provider/{id}/configuration/{configId}][%d] getProviderConfigurationNotFound  %+v", 404, o.Payload)
}
...
func (o *GetProviderConfigurationInternalServerError) Error() string {
	return fmt.Sprintf("[GET /tf/provider/{id}/configuration/{configId}][%d] getProviderConfigurationInternalServerError  %+v", 500, o.Payload)
}
