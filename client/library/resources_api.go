...
func (a *ResourcesApiService) ListResourceGroups(ctx context.Context) (ResponseListResources,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ResponseListResources
	)
...
/* ResourcesApiService 
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param group Root level resources
 @return ResponseListResources*/
func (a *ResourcesApiService) ListResources(ctx context.Context, group string) (ResponseListResources,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
